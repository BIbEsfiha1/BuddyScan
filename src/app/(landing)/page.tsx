  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-background via-muted/5 to-primary/10 text-foreground">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-4xl font-bold tracking-tighter text-primary sm:text-5xl xl:text-6xl/none">
                    BudScan: Cultivo Inteligente ao Seu Alcance
                  </h1>
              ...
              <Image
                ...
                src="https://picsum.photos/seed/budscan-hero/600/400"
                width="600"
                height="400"
                alt="BudScan Hero Image"
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Do QR Code ao diário detalhado e análises inteligentes, o BudScan oferece as ferramentas certas.
                </p>
              </div>
            </div>
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
              <Card className="card hover:border-primary/30 transition-all duration-300">
                ...
                <CardContent>
                    <Image data-ai-hint="qr code scanning cannabis plant" src="https://picsum.photos/seed/budscan-qr/300/200" width={300} height={200} alt="QR Code Scan" className="rounded-md object-cover"/>
                </CardContent>
              </Card>
              <Card className="card hover:border-primary/30 transition-all duration-300">
                <CardHeader className="pb-4">
                 ...
                 <CardContent>
                    <Image data-ai-hint="digital plant diary cannabis notes" src="https://picsum.photos/seed/budscan-diary/300/200" width={300} height={200} alt="Plant Diary" className="rounded-md object-cover"/>
                </CardContent>
              </Card>
              <Card className="card hover:border-primary/30 transition-all duration-300">
                <CardHeader className="pb-4">
                 ...
                 <CardContent>
                    <Image data-ai-hint="ai analysis plant health cannabis leaves" src="https://picsum.photos/seed/budscan-ai/300/200" width={300} height={200} alt="AI Analysis" className="rounded-md object-cover"/>
                </CardContent>
              </Card>
               <Card className="card hover:border-primary/30 transition-all duration-300">
                <CardHeader className="pb-4">
                 ...
                 <CardContent>
                    <Image data-ai-hint="cannabis plant growth stages tracking dashboard" src="https://picsum.photos/seed/budscan-status/300/200" width={300} height={200} alt="Status Tracking" className="rounded-md object-cover"/>
                </CardContent>
              </Card>
              <Card className="card hover:border-primary/30 transition-all duration-300 lg:col-span-2"> {/* Example spanning 2 columns */}
                <CardHeader className="pb-4">
                 ...
                 <CardContent>
                    <Image data-ai-hint="organized cannabis grow room inventory system" src="https://picsum.photos/seed/budscan-org/620/200" width={620} height={200} alt="Organization" className="rounded-md object-cover w-full"/>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-background">
        <p className="text-xs text-muted-foreground">&copy; {new Date().getFullYear()} BudScan. Todos os direitos reservados.</p>
